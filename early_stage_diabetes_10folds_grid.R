...
data = read.csv("early_stage_diabetes.csv")
...
saveWorkbook(work_book, "repeated_holdout_cross_val_50_early_stage_diabetes.xlsx", overwrite = TRUE)


################################################################################ accuracy
# load results data 
results_shannon = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                            sheet = "Shannon")

results_renyi = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                          sheet = "Renyi")

results_sh_mit = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                           sheet = "Sharma_Mittal")

results_sh_tan = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                           sheet = "Sharma_Taneja")

results_tsallis = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                            sheet = "Tsallis")

results_kapur = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                          sheet = "Kapur")

results_kaniad = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                           sheet = "Kaniadakis")

index = read.xlsx("repeated_holdout_cross_val_50_early_stage_diabetes.xlsx",
                  sheet = "index")
